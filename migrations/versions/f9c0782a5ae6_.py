...
Revision ID: f9c0782a5ae6
Revises: 
Create Date: 2023-09-22 19:49:58.106655
...
def upgrade():
    ...
    sa.Column('contact_number', sa.Integer(), nullable=False),
    sa.Column('address', sa.String(length=50), nullable=False),
    sa.Column('email_financial', sa.String(length=60), nullable=False),
    sa.Column('student_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email_financial'),
